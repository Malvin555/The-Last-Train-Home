...
define gui.accent_color = '#f16423'
...
define gui.hover_color = '#f5a986'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#f5a986'
...
define gui.text_font = "Font/MagnisaSans.otf"

## The font used for character names.
define gui.name_text_font = "Font/MagnisaSans.otf"

## The font used for out-of-game text.
define gui.interface_text_font = "Font/MagnisaSans.otf"
...
define gui.namebox_height = 6

## The borders of the box containing the character's name, in left, top, right,
## bottom order.
define gui.namebox_borders = Borders(-50, 10, 0, 0)
...
define gui.choice_button_width = 1328
define gui.choice_button_height = 124
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(30, 45, 30, 8)
define gui.choice_button_text_font = gui.text_font
define gui.choice_button_text_size = gui.text_size
define gui.choice_button_text_xalign = 0.5
define gui.choice_button_text_idle_color = '#fff'
define gui.choice_button_text_hover_color = "#f5a986"
...
define gui.slot_button_width = 432
define gui.slot_button_height = 247
...
define config.thumbnail_width = 423
define config.thumbnail_height = 242
...
define gui.skip_frame_borders = Borders(24, 12, 75, 8)

## The frame that is used as part of the notify screen.
define gui.notify_frame_borders = Borders(24, 12, 60, 8)
...
define gui.nvl_borders = Borders(0, 50, 0, 30)
...
define gui.nvl_thought_xpos = 570
define gui.nvl_thought_ypos = 50
...
init python:
    ...
    def small():
        ...
        gui.choice_button_width = 1328
        gui.choice_button_text_size = 45

        gui.navigation_spacing = 70
        gui.pref_button_spacing = 0

        gui.history_height = 150
        gui.history_text_width = 1110
        ...
        gui.nvl_name_xpos = 570

        gui.nvl_text_width = 900
        gui.nvl_text_xpos = 570
        gui.nvl_text_ypos = 90

        gui.nvl_thought_width = 900
        gui.nvl_thought_xpos = 570

        gui.nvl_button_width = 1860
        gui.nvl_button_xpos = 675
